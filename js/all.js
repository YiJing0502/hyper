...
funcSecond = document.querySelector('.func-second');
biChevronRightAll = document.querySelectorAll('.bi-chevron-right');
funcA = document.querySelectorAll('.func-a');
//   console.log(funcA);
...
funcA.forEach((element) => {
    element.addEventListener('click', () => {
        // Toggle the classes for each biChevronRight element when .func-a is clicked
        biChevronRightAll.forEach((chevronElement) => {
            chevronElement.classList.toggle('bi-chevron-down');
            chevronElement.classList.toggle('bi-chevron-right');
        });
    });
});
